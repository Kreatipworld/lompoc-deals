...
async function main() {
  ...
  const dealSeed: {
    ...
    // --- deals for real Lompoc businesses ---
    {
      ...
      description: "Fresh fish, never frozen. Mention Lompoc Locals at checkout.",
      discountText: "$3 OFF",
      days: 21,
    },
    {
    ...
    },
    {
      ...
      description: "Valid Sunday–Thursday. Reserve by calling or mentioning Lompoc Locals.",
      discountText: "15% OFF",
      days: 30,
    },
    {
    ...
    },
    {
      ...
      description: "Includes multi-point inspection. Mention Lompoc Locals when scheduling.",
      discountText: "$20 OFF",
      days: 45,
    },
    {
    ...
    },
    {
      ...
      description: "Fades, tapers, classic cuts. Mention Lompoc Locals when you come in.",
      discountText: "$5 OFF",
      days: 21,
    },
    {
    ...
    },
    {
      ...
      description: "Long-lasting color with gel top coat. Mention Lompoc Locals.",
      discountText: "$10 OFF",
      days: 21,
    },
    {
    ...
    },
    {
      ...
      description: "Any showing after 5pm. One discount per Lompoc Locals redemption.",
      discountText: "$2 OFF",
      days: 30,
    },
    {
