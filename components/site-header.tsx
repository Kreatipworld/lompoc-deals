...
export async function SiteHeader() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-40 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 sm:sticky sm:left-auto sm:right-auto">
