# Week of Sep 1 — posts 1 & 2 (cover system v2)

Publish order per post (5 min apart): IG feed → IG Story (link sticker) → Facebook → TikTok.

## 1. Spanish announcement — es-announce-{ig,tt}.png
**IG feed:**
Lompoc Locals, ahora en español. 🌸

Las ofertas, las noticias, los eventos y el mapa — todo el sitio, en tu idioma. Mismo pueblo, dos idiomas.

The whole site now speaks Spanish too — deals, news, events, and the map. Same town, both languages.

📍 lompoclocals.com/es — link in bio

#Lompoc #LompocCA #EnEspañol #LompocLocals #CentralCoast #805 #Latinos805
**IG Story:** tt PNG · link sticker → https://www.lompoclocals.com/es (label: "En español") · text: "Todo el sitio, en tu idioma 🌸"
**Facebook:** same as IG feed but URL written out: https://www.lompoclocals.com/es
**TikTok:** Lompoc Locals ahora en español 🌸 ofertas, noticias, eventos y el mapa — en tu idioma. lompoclocals.com/es #Lompoc #EnEspañol #LompocLocals #805

## 2. Eddie's Grill member spotlight — eddies-spotlight-{ig,tt}.png
**IG feed:**
Member spotlight: EDDIE'S GRILL 🍔

Char-grilled burgers, the pastrami people drive for, fresh salads, wraps and shakes — family-run on N H Street, treating every guest like family.
...
#Lompoc #LompocEats #ShopLocal #LompocLocals #Burgers #805
**IG Story:** tt PNG · link sticker → https://www.lompoclocals.com/deals/165/claim (label: "10% off") · mention @eddiesgrill805 if that's their handle — VERIFY handle before posting
**Facebook:** same as IG feed, URL written out.
