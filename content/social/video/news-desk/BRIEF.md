...
- Voiceover: DONE 2026-08-24 — Higgsfield Emily on seed_audio (user A/B'd both engines and kept take 1; ElevenLabs take rejected). Closer rewritten to "Your town, your news." — "on the record" collided with the Lompoc Record newspaper — spoken AND on-screen in both s4-outro files. 3.3 credits billed total (2.0 + 0.9 rejected take + 0.4 new closer), verified via transactions, zero drift. 6 per-scene WAVs in public/ at track 10 (s1 0.3, s2 4.7/9.0/13.3, s3 17.7, s4 21.45) in index.html + index-4x5.tmpl. Both aspects re-rendered with watermarks + VO and delivered.
