...
- Voiceover: DONE 2026-08-24 — Higgsfield Emily on the ElevenLabs engine (user picked it over seed_audio in an A/B for a more human read). 2.9 credits billed total, verified via transactions, zero drift. Sliced into 6 per-scene WAVs in public/, placed at track 10 (s1 0.3, s2 4.7/9.0/13.3, s3 17.7, s4 21.6) in index.html + index-4x5.tmpl. Both aspects re-rendered with watermarks + VO and delivered.
