...
>
> Your on-site restaurant makes you one of the few Lompoc hotels where guests never have to leave the property. That's a real differentiator for wine country visitors who want a full-service stay. A deal — even a simple "complimentary upgrade for stays of 2+ nights" — would surface to everyone searching for Lompoc hotels on our platform.
>
...
| Property | Tier | Why target | Contact method |
|----------|------|-----------|----------------|
| Embassy Suites by Hilton Lompoc | Standard → Premium | Largest full-service; highest ADR; deal posts would move units | Email GM + call front desk |
| Hilton Garden Inn Lompoc | Standard → Premium | On-site restaurant = full package; strong brand | Email GM |
| Hampton Inn & Suites | Standard | Reliable mid-range; high web visibility helps them compete | Email |
| Holiday Inn Express | Standard | Families market; breakfast + pool deals easy to write | Email |
| O'Cairns Inn & Suites | Standard | Boutique feel; garden courtyard = Instagram-worthy | Email |
| Inn of Lompoc | Free → Standard | Pet-friendly angle; loyal base to email | Email or walk-in |

---

## Pitch Talking Points (All Hotels)

1. **"Your property is already listed — with a map."** Zero resistance opener. Show them the URL.
2. **"472 Lompoc businesses are already on our interactive map."** Scale signals legitimacy.
3. **"We just published a hotels guide that ranks for 'hotels in Lompoc CA' searches."** Direct traffic proof.
4. **"Deal alerts go directly to subscribers — no algorithm."** Email delivery is a real hook for hotel marketers used to OTA dependency.
5. **"No booking commission. Flat $19.99/month."** Immediately differentiates from Expedia/Booking.com.
6. **"Start free — upgrade whenever."** Zero barrier to entry.

---

## KPI Target

- 3 hotel accounts on Standard or Premium within 30 days of outreach
- $59.97–$119.97/mo MRR from hotel vertical alone
- Each hotel deal post: ~200–400 deal alert emails to relevant subscribers
