...
| Business Name | Category | Contact | Method | Date | Status | Notes |
|--------------|----------|---------|--------|------|--------|-------|
| | | | | | | |

*Copy this table into a spreadsheet for CRM tracking.*

---

## Outreach Targets — Week 1 (Lompoc)

Priority categories based on deal frequency + community interest:
1. Restaurants & cafes (highest consumer demand)
2. Hair salons & nail salons (repeat visits, good for coupons)
3. Auto repair shops (price-sensitive, deals work well)
4. Retail boutiques (sales, promotions)
5. Fitness / gyms (trial offers)
