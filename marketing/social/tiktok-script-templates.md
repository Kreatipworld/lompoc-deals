...
- **Format:** 15–30 second vertical video (9:16), auto-captions on
...
## Series Format: "Deal of the Week"

A repeatable weekly format. Each episode = 1 deal highlight from a Lompoc merchant.
...
```
0:00–0:03  HOOK — "I found this deal at a local Lompoc [business]..."
...
## Script Template 1 — Restaurant Deal (EN)
...
## Script Template 2 — Salon/Beauty Deal (EN)
...
## Script Template 3 — Generic "Did You Know" (works for any deal)
...
## Script Template 4 — Merchant Story (30-sec, for creator partnerships)

*Brief for creator partner: film yourself visiting or showing the merchant's product/space*
...
When reaching out to Lompoc TikTok creators (target: 2k–20k followers, local content):

**What we're looking for:**
- Lompoc-based or SYV-based creator
- Posts lifestyle, food, local, or community content
...
- [ ] Add ES captions as second language track or text overlay
- [ ] Add hashtags (see platform notes above)
- [ ] Post Tue/Thu/Sat 6–9 PM Pacific
- [ ] Log in campaign tracker: date, deal featured, views at 24h, 72h, link clicks
