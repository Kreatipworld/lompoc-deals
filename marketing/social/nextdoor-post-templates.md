...
- Nextdoor skews 35–65+, homeowners, higher local trust than Facebook
- Posts appear in neighborhood feeds — write as a neighbor, not a brand
- Avoid heavy promotional language ("SALE!", "$$$") — gets flagged or ignored
- Always include the URL as plain text (Nextdoor strips most links)
- Spanish version: post separately in same thread as a reply, or as a separate post if you have a Spanish-speaking neighbor identity
- Best posting times: Tue/Thu 7–9 AM and 6–8 PM Pacific
- Post frequency: 1–2x/week max (Nextdoor penalizes over-posting from business accounts)

---

## Template 1 — Weekly Deal Roundup (EN)

**Subject line:** Deals this week in Lompoc
...
💇 [Salon name] — [deal, e.g., "Free deep conditioning with any cut"]
...
## Template 1 — Weekly Deal Roundup (ES)

**Subject line:** Ofertas de esta semana en Lompoc
...
💇 [Nombre del salón] — [ej. "Tratamiento profundo gratis con cualquier corte"]
...
## Template 2 — New Deal Alert (EN)

**Subject line:** New deal just posted — [Business name]
...
## Template 2 — New Deal Alert (ES)

**Subject line:** Nueva oferta publicada — [Nombre del negocio]
...
| Week | Day | Time | Template | Notes |
|------|-----|------|----------|-------|
| 1 | Tuesday | 7:30 AM | Template 3 (Community Intro) | EN post + ES reply |
...
Log all posts in this table:

| Date | Template | Neighborhood | Views | Replies | Signups (est.) |
|------|----------|-------------|-------|---------|----------------|
| | | | | | |

Report results in KPIS.md at end of each cycle.

---

## Nextdoor Neighborhoods to Target

Primary (highest population density in Lompoc):
1. **Central Lompoc** — downtown, near businesses
2. **Hapgood** — residential, family-heavy
3. **North Lompoc** — higher homeownership
4. **La Purisima** — working-class, Hispanic-majority → prioritize ES posts here

Secondary:
- Vandenberg Village (near VSFB — separate military community)
- Orcutt (Santa Maria edge — test if reach extends)
