...
**Frequency:** 3x/week  
**Format mix per week:**
- 1 Deal Highlight (Reel or static card)
- 1 Merchant Story (Reel or carousel — introduce a local business)
- 1 Community Post (poll, question, local tip, or user-generated content)

**Languages:** Alternate EN/ES posts. Every caption gets both languages (EN first, ES below with 🇲🇽 separator). 

**Posting times (Pacific):**
- Tue: 6:30 PM (deal highlight)
- Thu: 12:00 PM (merchant story — lunch scroll)
...
### Template A — Deal Highlight (Static or Reel)

**Visual:** Screenshot or styled card of the deal (deal title, business name, discount, expiry)
...
### Template C — Community Post (Poll / Question / Tip)

**Option C1 — Poll:**
> Quick poll for Lompoc 👇
>
> What kind of local deal would you use MOST?
>
...
> 🔧 Local services
>
> Drop your answer below or use the poll! We're building the best local deals site for Lompoc — your input shapes what we feature.
>
...
| Day | Type | Content |
|-----|------|---------|
| Tue | Deal Highlight | Best current deal (restaurant or salon — visually strongest) |
| Thu | Merchant Story | Feature a well-known Lompoc business (establish credibility) |
| Sat | Community | Poll: "What kind of deal do you want more of?" |

### Week 2 — Build Awareness

| Day | Type | Content |
|-----|------|---------|
| Tue | Deal Highlight | Feature a deal expiring soon (urgency) |
| Thu | Merchant Story | Feature a Hispanic-owned business (resonates with 63% of Lompoc) — post in ES primary |
| Sat | Community | Tip: "3 things you can save on this week in Lompoc" |
...
| Day | Type | Content |
|-----|------|---------|
| Tue | Deal Highlight | Feature a food deal with appetizing visual |
| Thu | Merchant Story | Behind-the-scenes at a local business (if merchant agrees to collaborate) |
| Sat | Community | Month-end recap: "X deals claimed this month by Lompoc neighbors" |

---

## Engagement Tactics

1. **Reply to every comment** within 24 hours — especially in first 2 weeks (IG algorithm rewards this)
2. **Follow local accounts:** Lompoc businesses, Lompoc Record, local influencers, Lompoc Chamber
3. **Story daily (even simple):** Poll, countdown, deal-of-the-day sticker → drives DMs → followers
4. **Tag merchants** in every deal highlight post — they often reshare (free amplification)
5. **Instagram Reels get 2–3x organic reach** vs static posts — prioritize Reels for deal highlights
...
|--------|----------|--------------|--------------|
| Followers | 0 | 150 | 500 |
| Post reach (avg) | — | 300/post | 800/post |
| Profile link clicks | 0 | 30/week | 100/week |
| DMs from merchants | 0 | 2/week | 5/week |

Report in KPIS.md at end of each cycle.
