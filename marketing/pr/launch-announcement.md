...
> Lompoc's free local business directory — restaurants, shops, services, deals, and more. All in one place, built for the Flower Capital.

**Spanish:**
> El directorio gratuito de negocios locales de Lompoc — restaurantes, tiendas, servicios, ofertas y más. Todo en un solo lugar.
...
**For businesses:**
- Free listing: photos, hours, description, contact info
- Post up to 3 deals free forever
- Standard plan ($19.99/mo): unlimited deals, priority placement, analytics
- No commissions on claimed deals. Ever.

**The vision:** Start in Lompoc. Expand to Santa Maria, Santa Barbara, Vandenberg Village, and eventually every underserved Central Coast community that doesn't have a local discovery layer.
...
**Maker's first comment (for Product Hunt):**
...
1. The bilingual EN/ES implementation — we think this is the right call for Lompoc's demographics, curious if others have solved this problem elsewhere
2. The category structure — did we miss anything for a community like this?

Thanks for checking us out. 🌸

---

## FACEBOOK GROUP LAUNCH POST (English)

**Target groups:** Lompoc Happenings, Lompoc CA Community, Lompoc Business Directory, Santa Ynez Valley
...
✅ Find hours, photos, and contact info for businesses you already love
✅ Claim deals and coupons directly on your phone
...
## FACEBOOK GROUP LAUNCH POST (Spanish)

**Target groups:** same groups + any Spanish-language Lompoc groups
...
**¿Qué pueden hacer?**
✅ Explorar negocios locales por categoría (gratis, sin cuenta)
✅ Encontrar horarios, fotos e información de contacto
...
It's bilingual (English + Spanish) and free to browse without an account.

Business owners: you can list your business for free. Just sign up at the site.

Would love to hear if this is useful for you, and if you know any local businesses that should be listed.
...
- **[X]+ businesses listed** across 9 categories
- **[X]+ active deals** to claim — free, no credit card
...
| Channel | Goal | Measure |
|---------|------|---------|
| Product Hunt | Top 10 in "Local" category | Hunt rank at 24h |
| Facebook groups | 100+ reactions, 50+ signups | UTM: `utm_source=facebook&utm_campaign=launch` |
| Nextdoor | 30+ reactions, 20+ signups | UTM: `utm_source=nextdoor&utm_campaign=launch` |
| Email blast | 40%+ open rate, 15% click | Email analytics |
| Total D1 signups | 100+ consumers, 10+ merchants | Signup funnel (REQ-001) |
