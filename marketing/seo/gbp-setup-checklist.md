...
A fully optimized GBP listing is the fastest way to appear in Google's local pack ("map pack") when someone searches "Lompoc deals" or "deals near me" in Lompoc. This is 100% free and requires zero engineering.

**KPI:** 20+ GBP profile clicks/week within 30 days of optimization

---

## Step-by-Step Setup (Human Action Required)
...
- **Email verification** is fastest if the domain email is set up
- Postcard verification takes 5–14 days but works without email setup

### Step 3 — Complete the Profile (do all of this immediately)
...
#### Hours
- Set to: Mon–Sun, open 24 hours (it's a website — always available)
- Or: remove hours field entirely for online-only businesses

#### Photos (upload these — required for credibility)
- [ ] Logo (400×400px minimum, PNG)
- [ ] Cover/banner image (1024×575px — shows in search results)
- [ ] 3–5 screenshots of the deals feed / map view
- [ ] 1 screenshot of the merchant dashboard
- *Note: Ask engineering for screenshots of the live site*

#### Attributes
- [ ] Identifies as: Woman-led / Latino-owned / Local business (check applicable)
- [ ] Online service: Yes
- [ ] Appointment required: No
- [ ] Accessible: Yes

### Step 4 — First GBP Post (do immediately after verification)
...
5. **Photos drive clicks:** Listings with 10+ photos get 35% more clicks. Add photos regularly
...
|--------|--------------|
| GBP profile views | 200+ |
| GBP clicks to website | 20+/week |
| GBP calls | N/A (online-only) |
| GBP reviews | 3+ |
| GBP direction requests | N/A (online-only) |
