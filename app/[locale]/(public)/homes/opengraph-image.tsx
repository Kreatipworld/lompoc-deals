...
// Share card for the homes market: brand field, no external photos.
export const alt = "Homes in Lompoc — for sale & for rent, by local agents"
...
export default function HomesOpengraphImage() {
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ fontSize: 96, fontWeight: 800, lineHeight: 1.0, letterSpacing: -3 }}>Homes in Lompoc</div>
          <div style={{ fontSize: 34, fontWeight: 500, marginTop: 18, color: "rgba(255,255,255,0.9)" }}>
            the real market, by local agents
          </div>
        </div>
        <div style={{ fontSize: 28, fontWeight: 600, color: "rgba(255,255,255,0.85)" }}>lompoclocals.com/homes</div>
      </div>
    ),
    { ...size }
  )
